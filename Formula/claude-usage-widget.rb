class ClaudeUsageWidget < Formula
  ...
  url "https://files.pythonhosted.org/packages/c8/ac/9e59078f18850c4ddc0357ce302f7528c0cb1629f4bfd657960bdfee0c16/claude_usage_widget-0.13.0.tar.gz"
  sha256 "2b10de4bf472902c0827b8cae595582bf4f3b5e8652231dd451a30c7fffc6822"
  license "MIT"
  ...
  test do
    assert_match "0.13.0", shell_output("#{bin}/claude-usage --version")
  end
end
